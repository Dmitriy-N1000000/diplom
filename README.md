...
<ul>
<li>просмотр расписания
<li>просмотр информации о фильмах
<li>выбор места в кинозале
<li>бронирование билета
</ul>
...
<h2>GitHub Pages</h2>
Проект доступен на GitHub Pages по следующей ссылке: https://dmitriy-n1000000.github.io/diplom/
